...
<head>
    ...
    <title>MesaLista - Contacto</title>

    <!-- Logo -->
    <link rel="icon" href="<?= BASE_URL ?>/public/assets/img/logo_1.png" />

    <!-- Estilos -->
    <link rel="stylesheet" href="<?= BASE_URL ?>/public/assets/css/admin/form.css" />
...
<body>
        ...
        <div class="container-fluid p-3 m-0 h-100 d-flex flex-column gap-2">
            ...
            <div class="row w-100 containMain">
                <nav aria-label="breadcrumb">
                    ...
                    <h1 class="fs-4 mb-0 fw-semibold">Contacto</h1>
                </nav>
            </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6">
                        <h2 class="text-center mb-3">¿Necesitas ayuda?</h2>
                        <p class="text-center mb-4">Completa el siguiente formulario y nos pondremos en contacto contigo.</p>

                        <form id="contactForm" method="post" action="#" class="p-4 border rounded bg-light shadow-sm">
                            <div class="mb-3">
                        ...
                        <p id="respuesta" class="mt-3 text-success text-center"></p>

                        <div class="text-center mt-3">
                            <a href="<?= BASE_URL ?>/admin" class="text-decoration-none">← Volver al Panel</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="<?= BASE_URL ?>/public/assets/js/admin/validar.js"></script>
